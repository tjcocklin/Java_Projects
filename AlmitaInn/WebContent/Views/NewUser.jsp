    ...
    <div id="formContainer">
        <form id= "userInput"action="../NewUserController" method="post">
	        <div id="name">
		        <h3>Name</h3>
		        First Name:
		        <input required type="text" name=Fname ><br>
		        Last Name:
	        ...
	        <div id="contact">
	        	<h3>Contact</h3>
	             Phone number:
	            <input required type="tel" name=phone id=phone><br>  
	        </div>
	        <div id="address">
	        	<h3>Address</h3>
	        	Street:
	            <input required type="text" name=street id=street><br> 
	        	City:
	        ...
	        <div id="login">
		        ...
		        password:
		        <input required type="text" name=pwd id=pwd><br>
	        </div>   
